...
<html lang="en">
    ...
    <head>
        ...
        <link rel="icon" type="image/png" sizes="192x192"  href="resources/img/icon/android-icon-192x192.png">
    ...
    <body data-spy="scroll" data-target="#navbar" data-offset="30">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <nav class="navbar navbar-dark navbar-expand-lg">
                            <a class="navbar-brand" href="index.html"><img src="resources/img/logo.png" class="img-fluid" alt="logo"></a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
        ...
        <header class="bg-gradient" id="home">
            ...
            <div class="img-holder mt-3"><img src="resources/images/screen1.png" alt="phone" class="img-fluid"></div>
        </header>
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="perspective-phone">
                    <img src="resources/images/screen7.png" alt="perspective phone" class="img-fluid">
                </div>
            </div>
        </div>
        <!-- // end .section -->
        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="resources/images/screen2.png" alt="dual phone" class="img-fluid">
                    </div>
        ...
        <div class="section light-bg">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <img src="resources/images/screen6.png" alt="iphone" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            <div class="container">
                ...
                <div class="testimonials owl-carousel">
                    ...
                    <div class="testimonials-single">
                        <img src="resources/images/client1.png" alt="client" class="client-img">
        ...
        <div class="section light-bg" id="gallery">
            <div class="container">
                ...
                <div class="img-gallery owl-carousel owl-theme">
                    <img src="resources/images/screen1.png" alt="image">
                    <img src="resources/images/screen2.png" alt="image">
                    <img src="resources/images/screen3.png" alt="image">
                    <img src="resources/images/screen4.png" alt="image">
                </div>
            </div>
        </div>
        <!-- // end .section -->
            ...
            <div class="container">
                <div class="call-to-action">
                    ...
                    <div class="my-4">
                        ...
                        <a href="https://play.google.com/store/apps/details?id=com.otemainc.foodfuzzapp" target="blank" class="btn btn-light"><img src="resources/images/playicon.png" alt="icon"> Google play</a>
                    </div>
